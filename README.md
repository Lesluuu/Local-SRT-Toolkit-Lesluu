...
> ⚠️ **声明：这个精度不高，是摸索 AI 做着玩的东西，只是记录一下。**
>
> **100% 本地离线运行 · 无需任何 API Key · 不付费 · 不上传视频/字幕**
>
> 一个面向**个人视频**的端到端字幕解决方案：
> **高精度本地语音转录**（尽量保留 哭/笑/叹气/犹豫 等语气词）
> + **日文/英文/韩文 → 中文 批量字幕翻译**（1:1 时间戳对齐）
>
> 本项目是我自己**第一次摸索 AI 辅助开发**的过程记录，整个开发链路（模型选型 / 下载排障 / 参数调优 / 排错 / UX 打磨）都由 AI 代码助手引导完成。过程详见 [`docs/PROJECT_STORY.md`](docs/PROJECT_STORY.md)。
